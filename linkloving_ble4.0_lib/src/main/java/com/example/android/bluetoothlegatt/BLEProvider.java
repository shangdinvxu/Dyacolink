...
//	public static final int MSG_BLE_NOT_SCAN = MSG_BLE_NOT_ENABLED + 1;
	...
	/** 指令代码：已经被绑定 */
	public static final int INDEX_INVALID_USER = INDEX_BOUND_NOCHARGE + 1;
	/** 指令代码：继续绑定指令 */
	public static final int INDEX_BOUND_GOON = INDEX_INVALID_USER + 1;
	/** 指令代码：绑定成功指令 */
...
//	};
   ...
   //0x13  获取设备信息
   public void getAllDeviceInfoNew(Context context,LPDeviceInfo deviceInfo)
   {
	  OwnLog.i(TAG, "..................getAllDeviceInfoNew Thread........................");
	   runIndexProess(context, INDEX_GAT_ALL_INFO_NEW,deviceInfo);
   }
