package com.linkloving.dyh08.prefrences;
...
//	public final static String KEY_LOGIN_LOGIN_INFO2 = "__logininfo__";
     ...
     * 心率自动同步
     */
    public final static String HEART_RATE_SYNCHRONIZATION = "HEART_RATE_SYNCHRONIZATION";

    /**
     * 手环设置
     */
    public final static String HAND_RING_SET = "HAND_RING_SET";
    /**
     * 定时器时间
     */
    public final static String TIME_SETTING_STRING = "TIME_SETTING_STRING";
    /**
     * 定时器开关
     * */
     ...
     * 储存心率自动测量自动
     */
    public static void setHeartrateSync(Context context, boolean ischecked) {
        SharedPreferences sharedPreferences;
        try {
            sharedPreferences = getAppDefaultSharedPreferences(context, true);
            SharedPreferences.Editor edit = sharedPreferences.edit();
            edit.putBoolean(HEART_RATE_SYNCHRONIZATION, ischecked);
            edit.commit();
        } catch (Exception e) {
            Log.e(TAG, e.getMessage());
        }
    ...
    /*获取心率自动同步信息*/
    public static boolean getHeartrateSync(Context context) {
        SharedPreferences sharedPreferences;
        boolean heartRate = false;
        try {
            sharedPreferences = getAppDefaultSharedPreferences(context, true);
            heartRate =   sharedPreferences.getBoolean(HEART_RATE_SYNCHRONIZATION, true);//获得设备信息
        } catch (Exception e) {
            Log.e(TAG, e.getMessage());
        }
        return  heartRate ;
     ...
     * 储存手环设置
     */
    public static void setHandRingSet(Context context, boolean ischecked) {
        SharedPreferences sharedPreferences;
        try {
            sharedPreferences = getAppDefaultSharedPreferences(context, true);
            SharedPreferences.Editor edit = sharedPreferences.edit();
            edit.putBoolean(HAND_RING_SET, ischecked);
            edit.commit();
        } catch (Exception e) {
            Log.e(TAG, e.getMessage());
        }
    ...
    /*获取手环设置信息*/
    public static boolean getHandRingSet(Context context) {
        SharedPreferences sharedPreferences;
        boolean heartRate = false;
        try {
            sharedPreferences = getAppDefaultSharedPreferences(context, true);
            heartRate =  sharedPreferences.getBoolean(HAND_RING_SET, false);//获得设备信息
        } catch (Exception e) {
            Log.e(TAG, e.getMessage());
        }
        return  heartRate ;
    ...
    /*获取定时器信息*/
    public static String getTimeSettingString(Context context) {
        SharedPreferences sharedPreferences;
        String jString = null ;
        try {
            sharedPreferences = getAppDefaultSharedPreferences(context, true);
           jString = sharedPreferences.getString(TIME_SETTING_STRING, "00:00");//获得设备信息
        } catch (Exception e) {
            Log.e(TAG, e.getMessage());
        }
        return jString;
     ...
     * 储存定时器设置
     */
    public static void setTimeSettingString(Context context, String time) {
        SharedPreferences sharedPreferences;
        try {
            sharedPreferences = getAppDefaultSharedPreferences(context, true);
            SharedPreferences.Editor edit = sharedPreferences.edit();
            edit.putString(TIME_SETTING_STRING, time);
            edit.commit();
        } catch (Exception e) {
            Log.e(TAG, e.getMessage());
        }
     ...
     * 储存定时器设置
     */
    public static void setTimeSettingBoolean(Context context, boolean time) {
        SharedPreferences sharedPreferences;
        try {
            sharedPreferences = getAppDefaultSharedPreferences(context, true);
            SharedPreferences.Editor edit = sharedPreferences.edit();
            edit.putBoolean(TIME_SETTING_BOOLEAN, time);
            edit.commit();
        } catch (Exception e) {
            Log.e(TAG, e.getMessage());
        }
    ...
    /*获取定时器信息*/
    public static boolean getTimeSettingBoolean(Context context) {
        SharedPreferences sharedPreferences;
        boolean jString = false ;
        try {
            sharedPreferences = getAppDefaultSharedPreferences(context, true);
            jString = sharedPreferences.getBoolean(TIME_SETTING_BOOLEAN, false);//获得设备信息
        } catch (Exception e) {
            Log.e(TAG, e.getMessage());
        }
        return jString;
