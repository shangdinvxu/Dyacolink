package com.linkloving.dyh08.ViewUtils.Wheelview;
...
public class WheelView extends ScrollView {
    ...
    private int type;
    public static final int TYPE_WEEK = 55;
    public static final int TYPE_MONTH = 56;
...
//                MyLog.e(TAG,"item"+item);
    ...
    private TextView createView(String item,int type) throws ParseException {
...
//           MyLog.e(TAG, "TYPE_MONTH" + item);
            if (item == null || item.length() <= 0){
                ...
                Date month = simYearMonth.parse(item);
...
//            position = divided + offset + 1;
    ...
    private void onSeletedCallBack() {
        if (null != onWheelViewListener) {
            Log.e("MonthViewFragment","选中的selectedIndex:"+selectedIndex);
            for(String data:items){
                Log.e("MonthViewFragment","data:"+data);
            }
