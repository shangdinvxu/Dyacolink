...
public class Geofence implements OnClickListener {
        ...
        public void onMapClick(LatLng arg0) {
            ...
            switch (fenceType) {
                ...
                case 1:
                    ...
                    overlays.add(WorkoutActivity.mBaiduMap.addOverlay(overlayOptions));
    ...
    protected static void addEntity() {
        ...
        WorkoutActivity.client.addEntity(WorkoutActivity.serviceId, entityName, columnKey, WorkoutActivity.entityListener);
    }
    ...
    private void createCircularFence() {
        ...
        // 创建者（entity标识）
        String creator = WorkoutActivity.entityName;
        // 围栏名称
        String fenceName = WorkoutActivity.entityName + "_fence";
        // 围栏描述
        String fenceDesc = "test";
        // 监控对象列表（多个entityName，以英文逗号"," 分割）
        String monitoredPersons = WorkoutActivity.entityName;
        // 观察者列表（多个entityName，以英文逗号"," 分割）
        String observers = WorkoutActivity.entityName;
        // 生效时间列表
        ...
        WorkoutActivity.client.createCircularFence(WorkoutActivity.serviceId, creator, fenceName, fenceDesc,
    ...
    private void createVertexesFence() {
        ...
        WorkoutActivity.client.createVertexesFence(WorkoutActivity.serviceId, creator, fenceName, fenceDesc,
                monitoredPersons, observers,
    ...
    private static void deleteFence(int fenceId) {
        WorkoutActivity.client.deleteFence(WorkoutActivity.serviceId, fenceId, geoFenceListener);
    }
    ...
    private void updateCircularFence() {
        ...
        WorkoutActivity.client.updateCircularFence(WorkoutActivity.serviceId, fenceName, fenceId, fenceDesc,
                monitoredPersons,
    ...
    private void updateVertexesFence() {
        ...
        // 报警条件（1：进入时触发提醒，2：离开时触发提醒，3：进入离开均触发提醒）
        int alarmCondition = 3;
        WorkoutActivity.client.updateVertexesFence(WorkoutActivity.serviceId, fenceName, fenceId, fenceDesc,
                monitoredPersons, observers,
                validTimes, validCycle, validDate, validDays, coordType,
    ...
    protected static void queryFenceList() {
        ...
        // 围栏ID列表
        String fenceIds = "";
        WorkoutActivity.client.queryFenceList(WorkoutActivity.serviceId, creator, fenceIds, geoFenceListener);
    }
    ...
    private void monitoredStatus() {
        ...
        // 监控对象列表（多个entityName，以英文逗号"," 分割）
        String monitoredPersons = WorkoutActivity.entityName;
        WorkoutActivity.client.queryMonitoredStatus(WorkoutActivity.serviceId, fenceId, monitoredPersons,
                geoFenceListener);
    }
    ...
    private void monitoredStatusByLocation() {
        ...
        // 监控对象列表（多个entityName，以英文逗号"," 分割）
        String monitoredPersons = WorkoutActivity.entityName;
        WorkoutActivity.client.queryMonitoredStatusByLocation(WorkoutActivity.serviceId, fenceId,
    ...
    private void historyAlarm() {
        ...
        WorkoutActivity.client.queryFenceHistoryAlarmInfo(WorkoutActivity.serviceId, fenceId, monitoredPersons, beginTime,
                endTime,
                geoFenceListener);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_circularfence:
                ...
                WorkoutActivity.mBaiduMap.setOnMapClickListener(mapClickListener);
    ...
    protected void initPopupWindowView() {
        ...
        View customView = mInflater.inflate(R.layout.tw_trace_menu_geofence, null);
    ...
    private void initOnGeoFenceListener() {
        ...
        geoFenceListener = new OnGeoFenceListener() {
            ...
            public void onRequestFailedCallback(String arg0) {
                // TODO Auto-generated method stub
                WorkoutActivity.mBaiduMap.clear();
                ...
                Toast.makeText(WorkoutActivity.mContext, "geoFence请求失败回调接口消息 : " + arg0, Toast.LENGTH_LONG).show();
    ...
    public void inputDialog(final String caption) {
        ...
        View dialogView = layoutInflater.inflate(R.layout.tw_trace_dialog_fence, null);
        ...
        builder.setNegativeButton("取消", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                // TODO Auto-generated method stub
                WorkoutActivity.mBaiduMap.setOnMapClickListener(null);
            }
    ...
    protected static void addMarker() {
        try {
            ...
            // 圆形围栏覆盖物
            if (null != circleFenceOverlaysOption) {
                circleFenceOverlay = WorkoutActivity.mBaiduMap.addOverlay(circleFenceOverlaysOption);
            }

            // 多边形围栏覆盖物
            if (null != vertexesFenceOverlayOption) {
                vertexesFenceOverlay = WorkoutActivity.mBaiduMap.addOverlay(vertexesFenceOverlayOption);
            }
        } catch (Exception e) {
