...
public class DistanceActivity$$ViewInjector<T extends com.linkloving.dyh08.logic.UI.distance.DistanceActivity> implements Injector<T> {
  @Override public void inject(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131624503, "field 'distanceTV'");
    target.distanceTV = finder.castView(view, 2131624503, "field 'distanceTV'");
