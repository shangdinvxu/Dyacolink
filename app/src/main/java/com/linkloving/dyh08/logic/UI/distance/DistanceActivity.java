...
import com.linkloving.dyh08.logic.UI.distance.WheelView.GoalWheelView;
import com.linkloving.dyh08.logic.UI.distance.asyncktask.DaySportAsynck;
 ...
 */
public class DistanceActivity extends ToolBarActivity{
    ...
    @InjectView(R.id.distances_textView)
    TextView distanceTV ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rightLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String stepGoal = PreferencesToolkits.getGoalInfo(DistanceActivity.this,PreferencesToolkits.KEY_GOAL_DISTANCE);
                wheelView.setSeletion(getIndexFromGoalList(stepGoalList,stepGoal));
                wheelView.setOffset(1);
                wheelView.setItems(stepGoalList);
                alertDialog = new AlertDialog.Builder(DistanceActivity.this)
                        .setView(layout).show();
                alertDialog.show();
                okbtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        PreferencesToolkits.setGoalInfo(DistanceActivity.this, PreferencesToolkits.KEY_GOAL_DISTANCE, wheelView.getSeletedItem());
                        updataGoalView();
                        switch (selectionIndex){
                            case 0:
                                new DaySportAsynck(null,step_number,stepCircleView,step_tv_date,DistanceActivity.this).execute(flushDate);
                                break;
                            case 1:
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                new YearSportAsynck(null,step_number,stepCircleView,step_tv_date,DistanceActivity.this).execute(flushYear);
                                break;
                        }
                        alertDialog.dismiss();
                    }
            ...
            case 3:
                ...
                yearViewFragment.setDataChangeListener(new IDataChangeListener() {
                        ...
                        public void onDataChange(String data) {
                            ...
                            new YearSportAsynck(null,step_number,stepCircleView,step_tv_date,DistanceActivity.this).execute(data);
                        }
                    });
