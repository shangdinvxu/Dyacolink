...
package com.linkloving.dyh08.logic.UI.launch.view.wheelview;
...
public class WheelView extends View {
    ...
    private int getItemHeight() {
        ...
        return getHeight() + 15 / visibleItems;
    }
    ...
    private void drawShadows(Canvas canvas) {
        // UPDATE YOLANDA：中间的高亮，动态计算，不能写死中间有几个
        int height = (getVisibleItems() - 1) * getItemHeight() / 2;
