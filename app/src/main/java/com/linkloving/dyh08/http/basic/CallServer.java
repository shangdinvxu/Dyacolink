...
public class CallServer {
     ...
     */
    public <T> void add(Context context, boolean isLoading, int what, Request<T> request, HttpCallback<T> callback, boolean canCancel) {
    ...
    public <T> void add(Context context,String message,int what, Request<T> request, HttpCallback<T> callback) {
        ...
        requestQueue.add(what, request, new HttpResponseListener<T>(context, request, callback,message, true));
    }
     ...
     * @param isLoading 是否显示dialog
     */
    public <T> void add(Context context, boolean isLoading, int what, Request<T> request, HttpCallback<T> callback) {
        requestQueue.add(what, request, new HttpResponseListener<T>(context, request, callback, true, isLoading));
    }
