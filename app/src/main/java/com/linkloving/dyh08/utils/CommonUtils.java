...
public class CommonUtils {
    ...
    public static String getTimeWithStr(String separator)
    {
        ...
        String time = (h >= 10 ? h : new StringBuilder("0").append(h).toString()) + separator
                + (m >= 10 ? m : new StringBuilder("0").append(m).toString())+ separator
                + (s >= 10 ? s : new StringBuilder("0").append(s).toString() ) /*+ separator + ms*/
                ;

        return time;
    }
    public static String getTimeWithStrNoS(String separator)
    {
        Calendar calendar = Calendar.getInstance();
    ...
    public static String getDateWithStr()
    {
        ...
        String date = y + "/" + (M >= 10 ? M : new StringBuilder("0").append(M).toString()) + "/" + (d >= 10 ? d : new StringBuilder("0").append(d).toString());
        return date;
    }
    ...
    /**
     * 比较当前日期是否在 String 的后面
     * @param string  yyyy-MM-dd
     * @return
     */
    public static boolean isAfterNow(String string  ){
        Calendar calendar = Calendar.getInstance();
        Date date = null;
        SimpleDateFormat sdfStandard = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault());
        try {
            date = sdfStandard.parse(string);
     ...
     * @return 比如2016-02-25
     */
    public static String getFlushDate(){
    ...
    /**
     *获得当周日期的时间用来刷新加载当天数据
     * @return 比如08/08-08/14
     */
    public static String getFlushWeek(){
        Calendar cal = Calendar.getInstance();
        String stringDate = new SimpleDateFormat("yyyy/MM/dd ").format(cal.getTime());
        return  stringDate ;
    }
     ...
     * @return 比如2016
     */
    public  static String getFlushYear(){
        Calendar cal = Calendar.getInstance();
    ...
    public static String getYearFirst(int year){
        ...
        String format = sdf.format(currYearFirst);
        return format;
    }
     ...
     * Date转String
     */
    public static String dateGetString(Date date){
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd", Locale.getDefault());
