    ...
    public  class MonthChartAsynckTask extends AsyncTask<Object, Object, List<DaySynopic>> {
        ...
        protected void onPostExecute(List<DaySynopic> daySynopics) {
            ...
            for(DaySynopic daySynopic:daySynopics){
                ...
                BarChartView.BarChartItemBean barChartItemBean = new BarChartView.BarChartItemBean(format, distance);
            ...
            barChartView.setDialogListerer(new BarChartView.DialogListerer() {
                ...
                public void showDialog(int i, int x, int y) {
                    barChartView.showPopupWindow(view, (int) month.get(i).itemValue, x, y);
                }
                @Override
